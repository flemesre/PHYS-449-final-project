...
if __name__ == '__main__':
    ...
    train_loss_history = []
    updated_train_loss_history = []
    test_loss_history = []
    updated_test_loss_history = []
    gamma_history = []
    ...
    for batch, (_den_field, _true_mass) in enumerate(train_dataloader):
        ...
        if batch % 10 == 0:
            ...
            updated_test_loss_history.append(updated_test_loss.detach().cpu())
    ...
    plt.plot(graph_x_axis, updated_test_loss_history,color ='blue',linestyle= 'dashed',label='updated testing loss')
    ...
    if plot_with_plotly:
        ...
        data_frame = {'iterations': graph_x_axis, 'training loss': train_loss_history, 'testing loss': test_loss_history,'updated training loss': updated_train_loss_history, 'updated test loss': updated_test_loss_history}
        fig = px.line(data_frame, x='iterations', y=["training loss", "testing loss","updated training loss","updated test loss"],
